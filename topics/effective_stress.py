...
def app():
    ...
    if st.button("Calculate Total Settlement", type="primary"):
        ...
        sigma_prev_boundary = 0.0 # Effective stress at top of current layer
        
        # We need to calculate Effective Stress at MID-HEIGHT of each layer
        # To do this, we need to sum weights of layers above + weight of half current layer
